Reproducible Research: Peer Graded Assignment 
----------------------------------------------
##Introduction
...
```r
# Load the activityData
activityData <- read.csv("./Repdata_Activity/activity.csv")
```
...
```r
# We use this that a TRUE boolean value is equivalent to 1 and a FALSE to 0.
...
These formulas gives a mean and median of 10766.19 and 10766.19 respectively.
